...
//stripped down version of https://github.com/AvaloniaUI/Avalonia/blob/master/src/Skia/Avalonia.Skia/FormattedTextImpl.cs
/// <summary>
/// Skia formatted text implementation.
/// </summary>
internal class SkiaFormattedTextImpl : IFormattedTextImpl
{
    private static readonly ThreadLocal<SKTextBlobBuilder> t_builder = new(() => new SKTextBlobBuilder());
    ...
    private readonly Size _constraint = new(double.PositiveInfinity, double.PositiveInfinity);
