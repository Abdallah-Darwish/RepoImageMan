...
namespace RepoImageMan
{
    public sealed partial class CommodityPackage
    {
        private readonly struct HandleImageInstanceInfo : IEquatable<HandleImageInstanceInfo>
        {
            ...
            public bool Equals(HandleImageInstanceInfo other) =>
                Size.Equals(other.Size) && PixelType.Equals(other!.PixelType);
        ...
        private readonly ConcurrentDictionary<HandleImageInstanceInfo, Image> _handlesCache =
            new ConcurrentDictionary<HandleImageInstanceInfo, Image>();
